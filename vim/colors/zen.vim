...
" Syntax highlighting
hi Comment       guifg=#157310  gui=none
"hi Todo         guifg=#225522  guibg=white    gui=italic
hi Todo          guifg=#598D38  guibg=#D8F6C0  gui=italic
hi Operator      guifg=#006ff8  gui=none
hi Identifier    guifg=#1a1a1a  gui=none
hi Statement     guifg=#0F69BB  gui=none
hi Type          guifg=#598D38  gui=none
hi Constant      guifg=#3A4B68  gui=none
hi Conditional   guifg=#107D52  gui=none
hi Delimiter     guifg=#1a1a1a  gui=none
hi PreProc       guifg=#007050  gui=none
hi Special       guifg=#598D38  gui=none
hi Keyword       guifg=#007050  gui=none
hi String        guifg=#bc6822  gui=none
hi Function      guifg=#4400a3  gui=none
